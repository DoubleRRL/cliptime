  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-full max-w-[95vw] -translate-x-1/2 -translate-y-1/2 gap-4 border border-border bg-background p-6 shadow-2xl duration-200 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 sm:max-w-3xl sm:rounded-xl",
          className,
        )}
        {...props}
      >
